...
function AddNewInterview() {
  ...
  const onSubmit=async(e)=>{
    ...
    "Depends on job position, job description and years of experience give us "+process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT+ " interview questions in JSON format . Give question and answered as field in JSON";
    ...
    <div>
      ...
      <Dialog open={openDialog}>
        ...
        <DialogContent className='max-w-2xl'>
          <DialogHeader>
            <DialogTitle className='text-2xl'>Tell us about the Job you are interviewing for</DialogTitle>
            <DialogDescription>
             ...
             <div>
              ...
              <div className='mt-7 my-3'>
                ...
                <Input placeholder="Ex. Data Analyst" required
                onChange={(event)=>setJobPosition(event.target.value)}></Input>
              </div>
              <div className=' my-3'>
                <label >Job Description</label>
                <Textarea placeholder="Ex. React,Azure,Flask,MongoDb etc" required
